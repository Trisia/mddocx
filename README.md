...
Claude Code 插件。将 Markdown 转换为符合学术规范的 Word 文档，支持三线表、图题/表题自动编号、页码、页眉等学术论文排版规范。
...
```bash
# 克隆到本地
git clone https://github.com/superluckykoo/mddocx.git ~/.claude/plugins/mddocx
